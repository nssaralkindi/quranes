...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "البث المباشر")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/nssaralkindi/quranes")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "master")
GIT_TOKEN = getenv("GIT_TOKEN", None)

SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/NNINB")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/Qurane_Tv")
